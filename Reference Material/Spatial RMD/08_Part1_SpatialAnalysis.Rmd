...
#Upgrade to a simple feature geometry column by adding a crs - this contextualizes the data as lat-long 
sfc_GraingerHall <- st_sfc(sfg_GraingerHall,crs=4326)
class(sfc_GraingerHall)
mapview(sfc_GraingerHall)

#Upgrade to a spatial dataframe - adds a flag with info
