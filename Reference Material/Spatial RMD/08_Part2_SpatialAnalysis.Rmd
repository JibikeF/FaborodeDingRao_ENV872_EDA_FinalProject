...
#Reveal the extent of this dataset via the st_bbox() function - bounding box around the features
st_bbox(counties_sf)
...
The data we'll add here is the CDC's Social Vulnerabiliy Index data.
...
wind_energy_huc8 <- read.csv('https://raw.githubusercontent.com/ENV859/EnviroAtlasData/main/Wind_Energy.csv') %>%
  ...
  group_by(HUC_8) %>%
  summarize(kWhkm2day = sum(kWkm2day))
...
#View the outputs
mapview(huc8_sf_wind, zcol ='kWkm2day')
