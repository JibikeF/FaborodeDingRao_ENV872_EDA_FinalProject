...
# TEST 1, combined data with merge 
biogas_pop_join <- merge(biogas_california_sf,population_data,by = "NAME", all = TRUE)
#added population data but original data missing
# TEST 2, combined data with left_join 
biogas_pop_join <- left_join(biogas_california_sf,population_data,by = 'NAME',all.y=TRUE)
#added population data but NA
str(biogas_pop_join)
